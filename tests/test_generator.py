...
def test_s3_bucket_format():
    ...
    for project in PROJECTS:
        ...
        region_bucket = "{1}-{0}-{2}".format(
            PROJECTS[project]["repo"], PROJECTS[project]["project"], PROJECTS[project]["region"]
        )

        shared_bucket = "common-{0}".format(
            PROJECTS[project]["project"],
        )
        region_shared_bucket = "common-{0}-{1}".format(PROJECTS[project]["project"], PROJECTS[project]["region"])
